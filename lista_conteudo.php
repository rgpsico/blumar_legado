...
//unset($_SESSION['filtro_nucleo'] );
 ...
 if(! isset($_POST["login"])){  header( 'Location: index.php' ) ; } else { 
                             ...
                             if($num_cidade2 != 0)
                                  {
										  ...
										  for ($rowcid = 0; $rowcid < pg_numrows($result_cidade2); $rowcid++) { $fk_usuario = pg_result($result_cidade2, $rowcid, 'fk_usuario'); }
