...
for ($rowtp = 0; $rowtp < pg_numrows($result_tipos); $rowtp++) {
	...
	if ($tp_produto == '1') {
		...
		echo 'Tours for incentives';
	} elseif ($tp_produto == '9') {
		echo 'Tours technical';
	...
	if ($tp_produto == '1') {
		echo ' onChange="javascript:pega_cid_tp1();" ';
	} elseif ($tp_produto == '2') {
		echo ' onChange="javascript:pega_cid_tp2();" ';
	} elseif ($tp_produto == '3') {
		echo ' onChange="javascript:pega_cid_tp3();" ';
	} elseif ($tp_produto == '4') {
		echo ' onChange="javascript:pega_cid_tp4();" ';
	} elseif ($tp_produto == '5') {
		echo ' onChange="javascript:pega_cid_tp5();" ';
	} elseif ($tp_produto == '6') {
		echo ' onChange="javascript:pega_cid_tp6();" ';
	} elseif ($tp_produto == '7') {
		echo ' onChange="javascript:pega_cid_tp7();" ';
	} elseif ($tp_produto == '8') {
		echo ' onChange="javascript:pega_cid_tp8();" ';
	} elseif ($tp_produto == '9') {
		echo ' onChange="javascript:pega_cid_tp9();" ';
	} elseif ($tp_produto == '10') {
		echo ' onChange="javascript:pega_cid_tp10();" ';
	} elseif ($tp_produto == '11') {
		echo ' onChange="javascript:pega_galeria_inspection();" ';
	}
	...
	if ($tp_produto == '1') {
		echo '<div id="miolo_prod1"></div> ';
	} elseif ($tp_produto == '2') {
		echo '<div id="miolo_prod2"></div> ';
	} elseif ($tp_produto == '3') {
		echo '<div id="miolo_prod3"></div>';
	} elseif ($tp_produto == '4') {
		echo '<div id="miolo_prod4"></div>';
	} elseif ($tp_produto == '5') {
		echo '<div id="miolo_prod5"></div> ';
	} elseif ($tp_produto == '6') {
		echo '<div id="miolo_prod6"></div> ';
	} elseif ($tp_produto == '7') {
		echo '<div id="miolo_prod7"></div> ';
	} elseif ($tp_produto == '8') {
		echo '<div id="miolo_prod8"></div>';
	} elseif ($tp_produto == '9') {
		echo '<div id="miolo_prod9"></div> ';
	} elseif ($tp_produto == '10') {
		echo '<div id="miolo_prod10"></div> ';
	} elseif ($tp_produto == '11') {
		echo '<div id="miolo_prod11"></div> ';
	}
	echo '<br>';
}
