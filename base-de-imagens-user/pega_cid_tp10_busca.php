...
echo'<div id="mapa-eco" ></div><div id="cabeca_bancoimg"><b>  '.strtoupper($nome_cid).'  PICTURES - '.pg_numrows($result_cidadestp).' images available</b> | <a href="#" onclick="javascript: back_search_result();" > <b>BACK TO SEARCH RESULT >></b></a></div>';
