...
echo'<b>CADASTRO DE IMAGEM</b><br>
		<br>
...
<input type="hidden" id="cidade_cod" value="0">'; 
	...
	<input type="text" id="tam_1"  size="70"><br>
	<br>
	Tamanho 2 - (300 x 200)<br>
	<input type="text" id="tam_2"  size="70"><br>
	<br>
	Tamanho 3 - (450 x 300)<br>
	<input type="text" id="tam_3"  size="70"><br>	
	<br>
	Tamanho 4 - (840 x 560)<br>
	<input type="text" id="tam_4"  size="70"><br>		
	<br>
	Tamanho 5 - original<br>
	<input type="text" id="tam_5"  size="70"><br>		
	<br>
	Zip - arquivo compactado<br>
	<input type="text" id="zip"  size="70"><br>	
	<br>
	Legenda em Ingles<br>
	<input type="text" id="legenda"  size="70"><br>	
	<br>
	Legenda em Português<br>
	<input type="text" id="legenda_pt"  size="70"><br>
	<br>
	Legenda em Espanhol<br>
	<input type="text" id="legenda_esp"  size="70"><br>	
	<br>
	Autor<br>
	<input type="text" id="autor"  size="70"><br>
	<br>	
	Autorização / Observações<br>
	<textarea cols="70" rows="7" id="autorizacao"></textarea><br>	
	<br>
	Palavras chave<br>	
	<textarea cols="70" rows="3" id="palavras_chave"></textarea><br>	
	<br>
	<input name="ativo_cli"  id="ativo_cli"  type="checkbox"  checked> Ativo para clientes<br>
	<br>
	<input name="fachada"  id="fachada"  type="checkbox"  checked> É Fachada<br>
	<br>
	<input type="submit" name="Submit"  onClick="javascript:insert_new_image();"  value="Inserir">
	<br>
	<br>';
