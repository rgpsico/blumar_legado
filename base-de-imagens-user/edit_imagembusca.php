...
for ($rowcid = 0; $rowcid < pg_numrows($result_cidadestp); $rowcid++)
{
 ...
 echo'</div>
    ...
    echo'<input type="hidden" id="tpmneu_for1" value="'.$mneu_for.'">
       ...
       if ($tp_produto  == '1' ) { echo'<a href="#" onclick="javascript: back_searchhtl_result();" > <b>BACK TO HOTEL SEARCH RESULT >></b></a>'; }  

      if ($tp_produto  == '10' ) { echo'<a href="#" onclick="javascript: back_searchcid_result();" > <b>BACK TO CITIES SEARCH RESULT >></b></a>'; }  


    	echo'<a href="#" onclick="javascript: back_search_result();" > <b>BACK TO SEARCH RESULT >></b></a></div><br>
