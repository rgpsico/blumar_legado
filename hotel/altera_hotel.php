		     ...
		     <div id="box6">FOTOS</div>
                ...
                <div id="box5">
				 ...
				 <div id="box5">
					 ...
					 <?php if(strlen($covid_19_pt) != 0) { echo'<input name="covid_19_pt"  id="covid_19_pt" type="text"  size="60" maxlength="150" value="'.$covid_19_pt.'"> <a href="##" onClick="javascript: del_covid19pt();"><img src="images/del.png"></a>'; }  else {echo'Nenhum arquivo inserido!';} ?>
					 </div>
                </div>
				 <div id="box5">
                ...
                <div id="box5">
                    ...
                    <?php if(strlen($covid_19_en) != 0) { echo' <input name="covid_19_en"  id="covid_19_en" type="text"  size="60" maxlength="150" value="'.$covid_19_en.'"> <a href="##" onClick="javascript: del_covid19en();"><img src="images/del.png"></a>'; } else {echo'Nenhum arquivo inserido!';} ?>
				    </div>
			    </div>
				<div id="box5">
		         ...
		         <div id="box13">
				        <div id="box12">
							<input type="checkbox" id="flaghtl" name="flaghtl" <?php  if  ($flaghtl == 't')  { echo 'checked';  }  ?>> - Ativo na Internet Blumar<br>
							<font size="1">( Ir&aacute; aparecer na internet se marcado )</font>
						</div>
						<div id="box12">
						    <input type="checkbox" id="flaglatino" name="flaglatino" <?php  if  ($flaglatino == 't')  { echo 'checked';  }  ?>  > - N&atilde;o aparecer Template no Tarif&aacute;rio Latino<br>
						    <font size="1">( N&atilde;o aparece o descritivo do Hotel no tarif&aacute;rio )</font>
						</div>
				 </div>
		         <div id="box13">
				        <div id="box12">
							<input type="checkbox" id="flat" name="flat" <?php  if  ($flat == 't')  { echo 'checked';  }  ?>  > - &Eacute; Flat  
						</div>
						<div id="box12">
						    <input type="checkbox" id="resort" name="resort" <?php  if  ($resort == 't')  { echo 'checked';  }  ?> > - &Eacute; Resort 
						</div>
				 </div> 
		          <div id="box13">
				        <div id="box12">
							<input type="checkbox" id="ecologico" name="ecologico" <?php  if  ($ecologico == 't')  { echo 'checked';  }  ?>> - &Eacute; Ecol&oacute;gico  
						</div>
						<div id="box12">
						    <input type="checkbox" id="flagfotopiscina" name="flagfotopiscina" <?php  if  ($flagfotopiscina == 't')  { echo 'checked';  }  ?>> - &Eacute; destaque no tarifario Latino 
						</div>
				 </div> 
		          <div id="box13">
				        <div id="box12">
							<input type="checkbox" id="bestdeal" name="bestdeal" <?php  if  ($bestdeal == 't')  { echo 'checked';  }  ?>> -   Best Deal  
						</div>
						<div id="box12">
						    <input type="checkbox" id="ativo_bnuts" name="ativo_bnuts" <?php  if  ($ativo_bnuts == 't')  { echo 'checked';  }  ?>> - Ativo site Bnuts<br>
							<font size="1">( Ir&aacute; aparecer na internet se marcado )</font>
						</div>
				 </div> 
		         <div id="box6">DESTAQUES PARA O TARIFARIO FIT - <font  size="1"  ><b> Selecionar somente 3 opcoes</b></font></div>
		          <div id="box13">
				        <div id="box12">
							<input type="checkbox" id="flaghtlimgmapa" name="flaghtlimgmapa"   <?php  if  ($flaghtlimgmapa == 't')  { echo 'checked';  }  ?> >  - Unique
						</div>
						<div id="box12">
						   <input type="checkbox" id="luxury" name="luxury"   <?php  if  ($luxury == 't')  { echo 'checked';  }  ?>> - Eco Friendly 
						</div>
				 </div>
		         <div id="box13">
				        <div id="box12">
							<input type="checkbox" id="novo" name="novo"  <?php  if  ($novo == 't')  { echo 'checked';  }  ?>> - New
						</div>
						<div id="box12">
						   <input type="checkbox" id="favoritos" name="favoritos"  <?php  if  ($favoritos == 't')  { echo 'checked';  }  ?>> -   Favorite
						</div>
				 </div>
		         <div id="box13">
		          ...
		          <div id="box13">
				        <div id="box12">
							<input type="checkbox" id="pg6fq7" name="pg6fq7"  <?php  if  ($pg6fq7 == 't')  { echo 'checked';  }  ?>> -   Promo especial
						</div>
						<div id="box12">
						   <input type="checkbox" id="pg4fq5" name="pg4fq5"  <?php  if  ($pg4fq5 == 't')  { echo 'checked';  }  ?>> -   Bonus Blumar
						</div>
				 </div> 
				 <div id="box13">
				        <div id="box12">
							<input type="checkbox" id="chdgratis" name="chdgratis"  <?php  if  ($chdgratis == 't')  { echo 'checked';  }  ?>> -   Crian&ccedil;a Gr&aacute;tis
						</div>
						<div id="box12">
						   <input type="checkbox" id="blumarrecomenda" name="blumarrecomenda" <?php  if  ($blumarrecomenda == 't')  { echo 'checked';  }  ?>> -   Blumar Recomenda
						</div>
				 </div> 					 
				<div id="box13">
				        <div id="box12">
							<input type="checkbox" id="blumarreveillon" name="blumarreveillon" <?php  if  ($blumarreveillon == 't')  { echo 'checked';  }  ?>> -   Reveillon 
						</div>
						<div id="box12">
						    <input name="allinclusive"  id="allinclusive" type="checkbox"   value="checkbox" <?php  if  ($allinclusive == 't')  { echo 'checked';  }  ?>> -   All Inclusive
						</div>
				 </div> 
...
if ($result_tour) {
 ...
 ?>
				 ...
				 <div id="box13">
				        <div id="box12">
							<input type="checkbox" id="ativo_mostrp" name="ativo_mostrp"  <?php  if  ($ativo_mostrp == 't')  { echo 'checked';  }  ?>> - &Eacute;	Most recommended properties 
						</div>
						<div id="box12">
