...
echo '<div id="box6">FACILIDADES DO HOTEL<br>Selecione as facilidades que deseja cadastrar</div>
      <div id="box6"></div>';
	...
	<div id="box6"><input type="button"  name="Go" value="Inserir" onclick="javascript:insert_add_fac_htl();"  ></div>
	<div id="box6"></div>
	';
	
	
	
   echo'<div id="box6">FACILIDADES DO HOTEL J&Aacute; CADASTRADAS</div>';
