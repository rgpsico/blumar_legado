...
$pk_cid_filtro_arr  =  $_POST["pk_abt_destinos_arr"];
...
if ($pk_cid_filtro_arr[$rowvf]  != '0' )
    {  
        ...
        for ($rowcid1 = 0; $rowcid1 < pg_numrows($result_cid_escolhida); $rowcid1++) {
            $nome_cid_selected = pg_result($result_cid_escolhida, $rowcid1, 'nome_en');
            $cidade_cod = pg_result($result_cid_escolhida, $rowcid1, 'cidade_cod');
             
            $cidade_escolhida = '<option value="'.$cidade_cod.'" selected>'.$nome_cid_selected.'</option>' ;
        ...
        order by 
           ...
           //    echo' <select id="cid_filtro"  name="cid_filtro[]"    >  <option value="0"  >Escolha uma cidade </option> ';
           // echo $cidade_escolhida;
            ...
            echo  $nome_cid_selected. '
            
             <a href="javascript:add_filtro_cid();"><b>+ add >></b></a> | <a href="javascript:remove_filtro_cid();"><b>- Remove </b></a> <br> ';
